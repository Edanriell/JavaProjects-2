...
public class Synchronization {
	...
	private static class CalculatorSyncBlock implements Calculator {
		private final String description = "Using synchronized block";
		private double prop;
	...
	private static class CalculatorSyncMethod implements Calculator {
		private final String description = "Using synchronized method";
		private double prop;
	...
	private static class CalculatorAtomicRef implements Calculator {
		private final AtomicReference<Double> prop = new AtomicReference<>(0.0);
		private final String description = "Using AtomicReference";
	...
	private static class CalculatorNoSync implements Calculator {
		private final String description = "Without synchronization";
		private double prop;
