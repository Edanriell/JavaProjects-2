package org.example.javafxbasics;
  ...
  /*
    ...
    */
	...
	private static class AllBlendEffectsThread extends Thread {
		private final String[] effects = {"ADD,DIFFERENCE", "COLOR_BURN,COLOR_DODGE", "LIGHTEN,DARKEN",
				"EXCLUSION,OVERLAY", "SCREEN,OVERLAY", "SOFT_LIGHT,HARD_LIGHT", "BLUE,GREEN",
				"BLUE,RED", "MULTIPLY,SRC_OVER", "SRC_ATOP,SRC_OVER"};
		private final Text txt1;
		private final Text txt2;
		private final Text txt3;
